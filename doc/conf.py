# -*- coding: utf-8 -*-
#
# Inria Paris/Rocquencourt cluster user documentation documentation build configuration file, created by
...
htmlhelp_basename = 'InriaParisRocquencourtclusteruserdocumentationdoc'
